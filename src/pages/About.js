	...
	return (
		<div className={styles.contentBox}>
			...
			<p style={{ textAlign: "left" }}>
				...
				labore et dolore magna aliqua. Velit egestas dui id ornare arcu odio ut sem nulla. Mauris
				augue neque gravida in. Neque laoreet suspendisse interdum consectetur libero id faucibus.
				Mauris sit amet massa vitae. Ac tortor dignissim convallis aenean et. Dolor morbi non arcu
			...
			<p style={{ textAlign: "left" }}>
				...
				neque ornare aenean euismod elementum nisi quis. Arcu cursus euismod quis viverra nibh cras
				pulvinar mattis. Habitant morbi tristique senectus et netus et malesuada fames. Facilisis
				sed odio morbi quis commodo. Gravida neque convallis a cras semper auctor neque vitae.
			</p>
