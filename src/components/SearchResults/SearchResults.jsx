    ...
    return (
        <Col>
            <Card className={styles.card}>
                <Card.Img className={styles.cardImg} variant="top" src="https://cdn.pixabay.com/photo/2019/12/15/17/06/cookie-4697591__340.jpg"/>
                <Card.Body className={styles.cardBody}>
                    <Card.Title>{bakeName}</Card.Title>
                    <Card.Text>
                        <p className={styles.itemDescTruncate}>Crunchy outside gooey inside, dark chocolate drizzle</p>
                        <p>from {bakePriceAndQuantity[0]} dollars onwards<br/>
